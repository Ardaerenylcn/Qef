...
const PRODUCTS = [
  ...
  { id: "6", name: "Limonata",         name_en: "Lemonade",        price: 45,  category: "Soğuk İçecekler",  description: "Taze sıkılmış limon",              description_en: "Freshly squeezed",             image_url: "/demo/limonata.png",        tags: ["Vegan"],  ingredients: ["lemon","water","sugar","ice"], in_stock: true,  position: 1 },
  ...
  { id:"10", name: "Fındıklı Kurabiye",name_en: "Hazelnut Cookie",  price: 40,  category: "Tatlılar",         description: "Günlük taze pişirilir",            description_en: "Freshly baked daily",          image_url: "/demo/cookie.png",          tags: ["Vegan"],  ingredients: ["flour","sugar","hazelnut","butter"], in_stock: true,  position: 2 },
];
