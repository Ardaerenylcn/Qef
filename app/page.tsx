    ...
    <main className="min-h-screen bg-white overflow-x-hidden" style={{ overscrollBehavior: "none" }}>
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-orange-50/50 to-white">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          {/* Sağ: telefon mockup — sadece masaüstünde */}
          <div className="flex-shrink-0 justify-center hidden md:flex">
            <div className="relative">
          ...
          {/* Mobilde telefon mockup yerine görsel önizleme */}
          <div className="md:hidden w-full flex justify-center">
            <div className="relative w-[220px]">
              <div className="absolute inset-0 bg-orange-200 rounded-full blur-3xl opacity-30 scale-110" />
              <div className="relative bg-gray-900 rounded-[40px] p-2.5 shadow-2xl ring-1 ring-white/10">
